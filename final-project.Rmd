...
yvalue <- (app2_total_deaths$deaths/app2_total_pop$total_pop)
    ...
    cdc %>% 
      ...
      ggplot(aes_string(x="age_group", y="yvalue"))+geom_bar(position="dodge",stat="identity")+
      labs(
